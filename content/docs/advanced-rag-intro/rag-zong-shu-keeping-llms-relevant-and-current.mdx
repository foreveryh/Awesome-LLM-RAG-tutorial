---
title: "RAG 综述: Keeping LLMs relevant and current"
...
LangChain has an [example](https://python.langchain.com/docs/use_cases/question_answering/#quickstart) of RAG in its smallest (but not simplest) form:
...
![RAG Architecture](/images/rag-architecture-1.webp)
...
![RAG Orchestration](/images/rag-architecture-2.webp)
...
![ETL Pipeline](/images/rag-architecture-3.webp)
